package com.bala.export.config;
...
@Configuration
public class ExportCompConfiguration {

	private static final Logger LOGGER = LoggerFactory.getLogger(ExportCompConfiguration.class);

	@Qualifier("ecKieContainer")
	@Bean
	public KieContainer ecKieContainer() throws IOException {

		KieContainer kContainer = getKieServices().newKieClasspathContainer();
